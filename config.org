...
#+BEGIN_SRC emacs-lisp
  ...
  (use-package counsel
    ...
    (ivy-add-actions
     ...
     '(("s" (lambda (v) (counsel-read-setq-expression (intern v))) "setq")))
  ...
  (use-package consult
    ...
    (defun consult-fd-dir ()
      (interactive)
      (pcase-let* ((consult-fd-args (append consult-fd-args '("-t d")))
                   (`(,prompt ,paths ,dir) (consult--directory-prompt "Fd" nil))
    ...
    (defun consult-fd-dir-here ()
      (interactive)
      (let* ((consult-fd-args (append consult-fd-args '("-I" "-t d")))
             (prompt "Fd: ")
    ...
    (defun consult-fd-file ()
      (interactive)
      (pcase-let* ((consult-fd-args (append consult-fd-args '("-t f")))
                   (`(,prompt ,paths ,dir) (consult--directory-prompt "Fd" nil))
                   (default-directory dir)
                   (builder (consult--fd-make-builder paths)))
        (find-file (consult--find prompt builder nil))))
    ...
    (defun consult-fd-file-here ()
      (interactive)
      (let* ((consult-fd-args (append consult-fd-args '("-I" "-t f")))
             (prompt "Fd: ")
             (builder (consult--fd-make-builder '("."))))
        (find-file (consult--find prompt builder nil))))
