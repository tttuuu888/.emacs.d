...
(defun find-file-in-tree (dir files &optional return-only-dir)
  "Find first matching file of FILES up to home or a root folder.
FILES can be a file name string or list of files. If RETURN-ONLY-DIR is
non-nil, return the directory containing the file instead of the full
