...
(use-package htmlize
  ...
  :after org
  :config
  (defun my-org-html-export-with-light-frame (orig-fun &rest args)
    (let ((frame (make-frame '((visibility . nil)
      ...
      (unwind-protect
          (with-selected-frame frame
            (apply orig-fun args))
        (delete-frame frame))))
  (advice-add 'org-html-export-to-html :around #'my-org-html-export-with-light-frame)
  (advice-add 'org-html-export-as-html :around #'my-org-html-export-with-light-frame))
