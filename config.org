...
(use-package vc
  ...
  (defun sk-vc-refresh-visible (&optional frame)
    "Update `sk-vc-mode' in every file buffer visible on FRAME."
...
(use-package magit
  ...
  (add-hook 'magit-post-refresh-hook #'sk-vc-refresh-visible)
