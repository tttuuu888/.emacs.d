...
#+BEGIN_SRC emacs-lisp
  ...
  (use-package org
    ...
    (setq
     ...
     `(("td" "Todo date" entry (file+headline ,my-org-gtd ,(my-today))
        "* TODO %?\n%^t" :empty-lines 1)
       ("tdt" "Todo date and time" entry (file+headline ,my-org-gtd ,(my-tomorrow))
        "* TODO %?\n%^T" :empty-lines 1)
       ("ed" "Event date" entry (file+headline ,my-org-gtd ,(my-today))
        "* %?\n%^t" :empty-lines 1)
       ("edt" "Event date and time" entry (file+headline ,my-org-gtd ,(my-today))
        "* %?\n%^T" :empty-lines 1)
       ("th" "Thing" entry (file+headline ,my-org-gtd "Things")
        "* %?\n%U" :empty-lines 1)
       ...
       ("wtd" "Work - Todo date"
        entry (file+headline ,my-org-gtd-work ,(get-week-form))
        "* TODO %?\n%^t" :empty-lines 1)
       ("wtdt" "Work - Todo date and time"
        entry (file+headline ,my-org-gtd-work ,(get-week-form))
        "* TODO %?\n%^T" :empty-lines 1)
       ("ww" "Work - Wait"
        entry (file+headline ,my-org-gtd-work ,(get-week-form))
