...
#+begin_src emacs-lisp
  ...
  ;;; Basic variables that do not belong to any package
...
#+BEGIN_SRC emacs-lisp
  ...
  (defun github-install (repo)
    (let ((vc-handled-backends '(Git))
          (url (format "https://www.github.com/%s" repo))
          (package (intern (file-name-base repo))))
...
#+BEGIN_SRC emacs-lisp
  ...
  (use-package paredit
    :hook ((clojure-mode cider-repl-mode emacs-lisp-mode janet-mode
  ...
  (use-package janet-mode
    ...
    (evil-leader/set-key-for-mode 'janet-mode
      ...
      "er" 'inf-janet-send-region))

  (use-package inf-janet
    :init
    (github-install "velkyel/inf-janet")
    :commands (sk-janet-eval inf-janet-eval-line-or-region)
    :config
    (sk-define-lisp-eval sk-janet-eval inf-janet-eval-region)
    (evil-leader/set-key-for-mode 'inf-janet-mode
      "l" 'my-comint-history))
#+END_SRC
* End
** Provide a feature
