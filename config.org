...
#+BEGIN_SRC emacs-lisp
  ...
  (defun sk-ctrl-c-map-to-evil-leader-c-map (mode mode-map)
...
#+BEGIN_SRC emacs-lisp
  ...
  (use-package org
    ...
    (sk-ctrl-c-map-to-evil-leader-c-map 'org-mode org-mode-map)
    (evil-leader/set-key-for-mode 'org-mode
      "cb" 'org-switchb
      "cp" 'my-org-capture-image
      "c." 'org-time-stamp
...
#+BEGIN_SRC emacs-lisp
  ...
  (use-package web-mode
    ...
    ;; C-c ... bindings to <leader> c... bindings
    (sk-ctrl-c-map-to-evil-leader-c-map 'web-mode web-mode-map))
