...
#+BEGIN_SRC emacs-lisp
  ...
  (use-package org
    ...
    (setq
       ...
       ("w" "Work GTD view"
        ((agenda "" ((org-agenda-files (list my-org-work))))
         (todo "TODO" ((org-agenda-files (list my-org-work))
                       (org-agenda-overriding-header "TODOs:")))
         (todo "PROG" ((org-agenda-files (list my-org-work))
                       (org-agenda-overriding-header "PROGs:")))
     ...
     `(("td" "Todo date"
        entry (file+headline ,my-org-gtd ,(my-today)) "* TODO %?\n%^t")
       ("tdt" "Todo date and time"
        entry (file+headline ,my-org-gtd ,(my-tomorrow)) "* TODO %?\n%^T")
       ("ed" "Event date"
        entry (file+headline ,my-org-gtd ,(my-today)) "* %?\n%^t")
       ("edt" "Event date and time"
        entry (file+headline ,my-org-gtd ,(my-today)) "* %?\n%^T")
       ("th" "Thing"
        entry (file+headline ,my-org-gtd "Things") "* %?\n%U")
       ("w" "Wait"
        entry (file+headline ,my-org-gtd "Things") "* WAIT %?\n%t")
       ("n" "Note"
