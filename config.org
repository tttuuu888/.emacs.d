...
(use-package vertico-repeat
  ...
  (add-to-list 'vertico-repeat-transformers #'consult--repeat-save-dir t)
  (advice-add 'vertico-repeat--run :around #'consult--repeat-restore-dir))
