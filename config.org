  ...
  (defun my-find-other-file ()
    ...
    (if-let* ((file (buffer-file-name))
              ...
              (others (or (my-find-file-in-dir regex)
                          (and (setq root (projectile-project-root))
...
#+BEGIN_SRC emacs-lisp
  ...
  (use-package counsel
    ...
    (defun my-counsel-fzf ()
      "Fzf on project root."
      (interactive)
      (counsel-fzf nil (projectile-project-root)))
...
#+BEGIN_SRC emacs-lisp
  ...
  (use-package project
    :ensure nil
    :config
    (setq project-find-functions '(projectile-project-root))
    ...
    (cl-defmethod eglot-client-capabilities ((server eglot-pyright))
      ...
      `(:workspace
        (:didChangeWatchedFiles
         (:dynamicRegistration
          ,(if (projectile-project-root default-directory)
               t
             :json-false)))))
