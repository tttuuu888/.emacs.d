...
#+BEGIN_SRC emacs-lisp
  ...
  (use-package org
    ...
    (setq
     ...
     my-org-note (expand-file-name (format-time-string "%Y_gtd.org") my-org-path)
     ...
     `(("t" "Todo" entry (file+headline ,my-org-note "Things")
        "* TODO %?\n%U" :empty-lines 1)
       ("w" "Wait" entry (file+headline ,my-org-note "Things")
        "* WAIT %?\n%t" :empty-lines 1)
       ("e" "Event" entry (file+headline ,my-org-note "Things")
        "* %?\n%U" :empty-lines 1)
       ("n" "Note" entry (file+headline ,my-org-note "Things")
        "* %?\n%U" :empty-lines 1)
       ("T" "Todo  :WORK:" entry (file+headline ,my-org-note "Things")
        "* TODO %?  :WORK:\n%U" :empty-lines 1)
       ("W" "Wait  :WORK:" entry (file+headline ,my-org-note "Things")
        "* WAIT %?  :WORK:\n%t" :empty-lines 1)
       ("E" "Event :WORK:" entry (file+headline ,my-org-note "Things")
        "* %? :WORK:\n%U" :empty-lines 1)
       ("N" "Note  :WORK:" entry (file+headline ,my-org-note "Things")
        "* %? :WORK:\n%U" :empty-lines 1))
