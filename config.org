     ...
     '("%e"
       (:eval
        (let* ((evil-info (and (featurep 'evil) evil-mode
               ...
               (git-branch (and buffer-file-name
                                (not (file-remote-p default-directory))
                                (git-branch-of-file buffer-file-name)))
...
#+BEGIN_SRC emacs-lisp
  ...
  (use-package geiser
    ...
    (defun my-geiser-eval-last-sexp-or-region (n)
      ...
      (setq deactivate-mark t))
    (sk-C-c-map-to-leader-c-map 'scheme-mode geiser-mode-map)
    (sk-C-c-map-to-leader-c-map 'geiser-repl-mode geiser-repl-mode-map)
