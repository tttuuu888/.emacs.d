...
#+BEGIN_SRC emacs-lisp
  ...
  (defun sk-alist-to-json (alist &optional omit-curly-braces)
    "Convert ALIST to json string. When OMIT-CURLY-BRACES is non-nil, omit curly
  braces wrapping."
    (concat
...
#+BEGIN_SRC emacs-lisp
  ...
  (use-package ox-reveal
    ...
    (setq my-reveal-init-options '((progress . false)
          ...
          (sk-alist-to-json my-reveal-init-options t)
