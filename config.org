...
#+BEGIN_SRC emacs-lisp
  (defun my-theme-setting (&optional light-theme)
    (let ((base-fg-color   (if light-theme "Black" "Gray80"))
          ...
          (region-bg-color (if light-theme "Gray" "DodgerBlue4")))
...
#+BEGIN_SRC emacs-lisp
  ...
  (use-package dired
    ...
    (defun my-dired-open-extern ()
      ...
      (interactive)
      (call-process "xdg-open" nil nil nil (dired-get-filename))))
  ...
  (use-package org
    ...
    (setq
     ...
     my-org-gtd-work (concat my-org-path (format-time-string "%Y_work.org"))
     org-agenda-custom-commands
     '(("g" "All GTD view"
        ((agenda)
         (todo "TODO" ((org-agenda-overriding-header "TODOs:")))
         (todo "PROG" ((org-agenda-overriding-header "PROGs:")))
       ...
       ("p" "Personal GTD view"
        ((agenda "" ((org-agenda-files (list my-org-gtd))))
         ...
         (todo "PROG" ((org-agenda-files (list my-org-gtd))
                       (org-agenda-overriding-header "PROGs:")))
         (todo "WAIT" ((org-agenda-files (list my-org-gtd))
                       (org-agenda-overriding-header "WAITs:")))))
       ("w" "Work GTD view"
        ((agenda "" ((org-agenda-files (list my-org-gtd-work))))
         (todo "TODO" ((org-agenda-files (list my-org-gtd-work))
                       (org-agenda-overriding-header "TODOs:")))
         (todo "PROG" ((org-agenda-files (list my-org-gtd-work))
                       (org-agenda-overriding-header "PROGs:")))
         (todo "WAIT" ((org-agenda-files (list my-org-gtd-work))
                       (org-agenda-overriding-header "WAITs:"))))))
     org-agenda-files (list my-org-path my-org-gtd-work)
     ...
     `(("1" "Todo Today" entry (file+headline ,my-org-gtd ,(my-today))
        "* TODO %?\n%U" :empty-lines 1)
       ("2" "Todo Tomorrow" entry (file+headline ,my-org-gtd ,(my-tomorrow))
        "* TODO %?\n%U" :empty-lines 1)
       ("a" "Thing" entry (file+headline ,my-org-gtd "Things")
        "* %?\n%U" :empty-lines 1)
       ("w" "Wait" entry (file+headline ,my-org-gtd "Things")
        "* WAIT %?\n%t" :empty-lines 1)
       ("e" "Event" entry (file+headline ,my-org-gtd "Things")
        "* %?\n%^t" :empty-lines 1)
       ("n" "Note" entry (file+headline ,my-org-gtd "Notes")
        "* %?\n%U" :empty-lines 1)

       ("T" "Todo - Work" entry (file+headline ,my-org-gtd-work ,(get-week-form))
        "* TODO %?\n%U" :empty-lines 1)
       ("W" "Wait - Work" entry (file+headline ,my-org-gtd-work ,(get-week-form))
        "* WAIT %?\n%t" :empty-lines 1)
       ("E" "Event - Work" entry (file+headline ,my-org-gtd-work ,(get-week-form))
        "* %?\n%^t" :empty-lines 1)
       ("N" "Note - Work" entry (file+headline ,my-org-gtd-work ,(get-week-form))
        "* %?\n%U" :empty-lines 1))
  ...
  (use-package hl-line
    :ensure nil
    :custom-face
    (hl-line ((((background light)) :background "darkseagreen2" :extend t)
