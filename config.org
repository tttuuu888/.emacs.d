...
#+BEGIN_SRC emacs-lisp :tangle yes
  ...
  (use-package evil
    ...
    (defconst evil-n-insert-notice '(:eval (evil-n-insert--update-mode-line)))
    (advice-add #'evil-insert-state :before
                (lambda (&rest _)
                  (setq mode-line-format
                        (cons evil-n-insert-notice mode-line-format))))
    (add-hook 'evil-insert-state-exit-hook
              (lambda ()
                (setq mode-line-format
                      (delete evil-n-insert-notice mode-line-format))))
    (defun evil-n-insert--update-mode-line ()
      (when (> evil-insert-count 1)
        (propertize (format "%dx" evil-insert-count)
  ...
  (use-package org
    ...
    (setq
     ...
     my-org-note-file (expand-file-name "notes.org" my-org-path)
     ...
     `(("t" "Todo" entry
        (file+headline ,my-org-note-file "ToDos")
        "* TODO %?\n%U" :empty-lines 1)
       ("T" "Todo with Clipboard" entry
        (file+headline ,my-org-note-file  "ToDos")
        "* TODO %?\n%U\n   %c" :empty-lines 1)
       ("n" "Note" entry
        (file+headline ,my-org-note-file "Notes")
        "* %?\n%U" :empty-lines 1)
       ("N" "Note with Clipboard" entry
        (file+headline ,my-org-note-file "Notes")
        "* %?\n%U\n   %c" :empty-lines 1)
       ("e" "Event" entry
        (file+headline  ,my-org-note-file "Events")
        "* %?\n%U" :empty-lines 1)
       ("E" "Event With Clipboard" entry
        (file+headline  ,my-org-note-file "Events")
        "* %?\n%U\n   %c" :empty-lines 1))
     org-default-notes-file my-org-note-file
