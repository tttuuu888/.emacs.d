...
#+BEGIN_SRC emacs-lisp
  ...
  (use-package evil
    :bind (("M-B" . evil-backward-WORD-begin)
           ...
           ("p"   . evil-paste-pgvy)
           ("*"   . evil-search-visualstar-forward)
           ("#"   . evil-search-visualstar-backward)
           ("n"   . evil-search-visualstar-forward)
           ("N"   . evil-search-visualstar-backward)
      ...
      (save-excursion
        ...
        (let* ((p1 (ignore-errors (search-forward "{")))
          ...
          (if p2
            ...
            (user-error "Can't find c function.")))))
    (defun evil-search-visualstar (beg end &optional backward)
      "Search for the visual selection."
      (evil-exit-visual-state)
      (setq isearch-forward (not backward))
      (evil-search
       (buffer-substring-no-properties beg end) (not backward) evil-regexp-search))
    (evil-define-motion evil-search-visualstar-forward (beg end)
      "Search for the visual selection forwards."
      :jump t
      :type exclusive
      (interactive "<r>")
      (evil-search-visualstar beg end))
    (evil-define-motion evil-search-visualstar-backward (beg end)
      "Search for the visual selection backwards."
      :jump t
      :type exclusive
      (interactive "<r>")
      (evil-search-visualstar beg end t))
